...
<h5 align="center" style="color:blue">Vehicle Receipt Count Report from <?php echo $fdate?> to <?php echo $tdate?></h5>
      <table class="table table-bordered">
        ...
        <tbody>
           <?php
$ret=mysqli_query($con,"select month(CreationDate) as lmonth,year(CreationDate) as lyear,count(ID) as totalcount from receipt where date(CreationDate) between '$fdate' and '$tdate' group by lmonth,lyear");
$cnt=1;
