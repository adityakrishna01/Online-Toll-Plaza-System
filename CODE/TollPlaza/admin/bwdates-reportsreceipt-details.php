...
?>
<h5 align="center" style="color:blue">Receipts report from <?php echo $fdate?> to <?php echo $tdate?></h5>
      <table class="table table-bordered">
        ...
        <tbody>
           <?php
$ret=mysqli_query($con,"select *from  receipt where date(CreationDate) between '$fdate' and '$tdate'");
$cnt=1;
