...
if (strlen($_SESSION['ttmsaid']==0)) {
    ...
    if(isset($_POST['submit']))
  {
    ...
    $monthlycost=$_POST['monthlycost'];
       ...
       $query=mysqli_query($con, "insert into  category(VehicleCat,cost,returncost,monthlycost) value('$catname','$cost','$returncost','$monthlycost')");
    if ($query) {
    ...
    echo $msg;
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched"  required="true" id="=returncost" name="returncost" value="">
            </div>

            <div class="form-group">
              <label class="control-label">Monthly Pass Cost</label>
              <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched"  required="true" id="monthlycost" name="monthlycost" value="">
            </div>
