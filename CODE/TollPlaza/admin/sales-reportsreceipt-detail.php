...
<th>Sales</th>
        ...
        <tbody>
           <?php
$ret=mysqli_query($con,"select month(CreationDate) as lmonth,year(CreationDate) as lyear,sum(Cost) as totalprice from receipt where date(CreationDate) between '$fdate' and '$tdate' group by lmonth,lyear");
$cnt=1;
